...
public class Servidor {
    ...
    static void servirArquivo(HttpExchange exchange, String nomeArquivo) throws IOException {
        String html = new String(Files.readAllBytes(Paths.get("src/resources/templates/" + nomeArquivo)), StandardCharsets.UTF_8);
    ...
    static String cabecalhoHtml(String titulo, String icone) {
        ...
        <head>
            ...
            <link href="/static/css/style.css" rel="stylesheet"> <!-- Aqui você vai linkar seu arquivo CSS -->
        </head>
